...
Надо понимать, что диаграммы могут отражать как текущее состояние as is для выявления проблем (область проблем в терминологии инженерии требований), так и будущее, проектируемое состояние to be (область решений). При создании диаграммы вы должны всегда понимать к какой области относится то, что ты создаешь.
...
7. Выполни следующие правила:
   ...
   3. Для обозначения объекта применяются понятные названия предметной области (не технические названия сущностей БД системы);
...
4. Построй диаграмму состояний выбранного объекта:
   ...
   2. Укажи на диаграмме каждое состояния объекта;
...
5. Запиши свои ответы в turn-in файле ex04\_<префикс продукта>\_dst.xxx (xxx — расширение файла).
...
💡 [Нажми сюда](https://forms.yandex.ru/cloud/65b9094273cee7087396703b/), **чтобы поделиться с нами обратной связью на этот проект**. Это анонимно и поможет команде Продукта сделать твоё обучение лучше.